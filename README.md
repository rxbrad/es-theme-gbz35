...
- Jul 20, 2017: Added MAME variants; folder highlighting in gamelist; prepend folder with § (Alt-0167) to add a folder icon (need to start folder name with a space to move to top of list)
